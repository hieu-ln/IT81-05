...
//C1.1 khai bao cau truc danh sach
#define MAX 100
int a[MAX];
int n;
...
//C1.4 Sap xep danh sach theo Insertion sort.
...
//C1.5 Sap xep danh sach theo Selection sort.
...
//C1.6 Sap xep danh sach theo Interchange sort
...
//C1.7 Sap xep danh sach theo Bubble sort
...
//C1.8 Sap xep danh sach theo Quick sort
...
//C1.9 Sap xep danh sach theo Heap sort
...

{
	...
	do{
		...
		cout << "3.Sap xep theo Insertion sort " << endl;
		cout << "4.Sap xep theo Selection sort " << endl;
		cout << "5.Sap xep theo Interchange sort " << endl;
		cout << "6.Sap xep theo Bubble sort " << endl;
		cout << "7.Sap xep theo Quick sort " << endl;
		cout << "8.Sap xep theo Heap sort " << endl;
